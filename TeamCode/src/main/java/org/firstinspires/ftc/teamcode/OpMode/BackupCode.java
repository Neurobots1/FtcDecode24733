...
@Configurable
@TeleOp
public class BackupCode extends OpMode {
    ...
    private org.firstinspires.ftc.teamcode.OpMode.StateMachineTele.ShooterState shooterState = org.firstinspires.ftc.teamcode.OpMode.StateMachineTele.ShooterState.OFF;
    ...
    public void init() {
        ...
        shooter.stop();
        shooterState = org.firstinspires.ftc.teamcode.OpMode.StateMachineTele.ShooterState.OFF;
    }
...
//transmet l'état de la gachette en mouvement pour le shooter
        if (leftTriggerJustPressed) {
            ...
            if (shooterState == org.firstinspires.ftc.teamcode.OpMode.StateMachineTele.ShooterState.OFF) {

                // premier clic
                // on commence le spinup
                shooterState = org.firstinspires.ftc.teamcode.OpMode.StateMachineTele.ShooterState.SPINNING_UP;
        ...
        switch (shooterState) {
            ...
            case SPINNING_UP:
                ...
                if (shooter.atSpeed()) {
                    ...
                    shooterState = org.firstinspires.ftc.teamcode.OpMode.StateMachineTele.ShooterState.FIRING;
